...
public class Database {
    ...
    public ArrayList<String> Select() throws SQLException {
        ...
        while (result.next()) {
                template.Template.instrum(64, "While", new template.Pair("result.next()",result.next()));
    ...
    public ArrayList<String> bestFiveTimes(String Diff) throws SQLException {
        ...
        while (reuslt.next()) {
            template.Template.instrum(158, "While", new template.Pair("reuslt.next()",reuslt.next()));
