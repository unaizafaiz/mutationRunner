...
public class mainMenu {
    ...
    private void initializeGameModes() {
        ...
        for (int counter = 0; counter < 5; counter++) {
            template.Template.instrum(164, "For", new template.Pair("counter",counter));
    ...
    private void initializeLevelsMenu() {
        ...
        for (int counter = 0; counter < 6; counter++) {
            template.Template.instrum(275, "For", new template.Pair("counter",counter));
			rowNo[counter] = new RowConstraints();
    ...
    public void initializeSavedGames() {
        ...
        for (int counter = 0; counter < savedGamesNumber; counter++) {
            template.Template.instrum(496, "For", new template.Pair("counter",counter), new template.Pair("savedGamesNumber",savedGamesNumber));
            ...
            savedGameTitle.setOnAction(e -> {
                ...
                for (int rowCounter = 0; rowCounter < 9; rowCounter++) {
                    template.Template.instrum(577, "For", new template.Pair("rowCounter",rowCounter));
					for (int columnCounter = 0; columnCounter < 9; columnCounter++) {
                        template.Template.instrum(579, "For", new template.Pair("columnCounter",columnCounter));
            ...
            savedGameDeleteButton.setOnAction(e -> {
                ...
                for (int blockCounter = gameBlockNumber; blockCounter < savedGamesNumber - 1; blockCounter++) {
                    template.Template.instrum(611, "For", new template.Pair("blockCounter",blockCounter), new template.Pair("savedGamesNumber",savedGamesNumber));
    ...
    private void assignSudoku(String Sudoku, Boolean[][] originalSudoku) {
        ...
        for (int row = 0; row < 9; row++) {
            template.Template.instrum(655, "For", new template.Pair("row",row));
			for (int column = 0; column < 9; column++) {
                template.Template.instrum(657, "For", new template.Pair("column",column));
